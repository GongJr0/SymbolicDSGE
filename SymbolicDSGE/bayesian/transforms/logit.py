"""Logit transform for :class:`Prior` specifications in Bayesian DSGE estimation.

Logit transforms map distributions on the unit interval to unconstrained sampling space.
