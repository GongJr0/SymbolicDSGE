"""Frozen pre-native Monte Carlo diagnostic-result oracle."""
...
class TestResult:
    ...
    def compute_pval(self) -> float64:
        ...
        object.__setattr__(self, "_frozen_dist", frozen_dist)
        pval_scalar = float64(pval.item())
        object.__setattr__(self, "_pval", pval_scalar)
        return pval_scalar
...
class MCResult:
    ...
    def __post_init__(self) -> None:
        ...
        object.__setattr__(self, "statistic_trace", statistic_trace)
        object.__setattr__(self, "status_trace", status_trace)
        object.__setattr__(self, "frozen_dist", frozen_dist)
        object.__setattr__(self, "pval_trace", pval_trace)

        object.__setattr__(self, "n", n)
        object.__setattr__(self, "mean_statistic", self.statistic_trace.mean())
        object.__setattr__(self, "mean_pval", self.pval_trace.mean())
        object.__setattr__(
            self,
            "rejection_rate",
